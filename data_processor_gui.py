...
class CMIDataProcessorGUI(QWidget):
    ...
    def select_input_folder(self):
        ...
        if folder:
            ...
            elif task_idx == 5: self.output_path.setText(os.path.join(folder, "result_files"))
            elif task_idx == 6: self.ouput_path.setText(os.path.join(folder, "populated_files"))
    ...
    def execute_current_task(self):
        ...
        # Route to AnalysisEngine
            ...
            user_particular = self.particular_field.text().strip()
            user_activity = self.activity_field.text().strip()
            from engines.metadata_populator import MetadataPopulator

            self.engine = MetadataPopulator(
